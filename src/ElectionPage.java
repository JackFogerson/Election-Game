...
public class ElectionPage {
	...
	public ElectionPage(String c, Statistics stat){
		candidate = c;
		s = stat;
		launchFrame();
	}
	...
	public void launchFrame(){
		...
		JButton campaignButton = new JButton("Election Results!");
		
		//events for button press
		pollButton.addActionListener(event -> pollFrame());
		campaignButton.addActionListener(event -> new ResultsPage(s));
