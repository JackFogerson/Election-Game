...
public class Statistics {
	...
	State Arizona = new State("Arizona", 11, 5109792, .71, .453, .448, .085, .027, .014);
	State Arkansas = new State("Arkansas", 6, 2259350, .61, .509, .388, .084, .027, .037);
	State California = new State("California", 55, 29649348, .72, .362, .563, .059, .034, .005);
	State Colorado = new State("Colorado", 9, 4109494, .69, .44, .479, .069, .018, .014);
	State Connecticut = new State("Connecticut", 7, 2821247, .73, .4, .513, .072, .034, .003);
	State Delaware = new State("Delaware", 3, 731367, .62, .363, .544, .078, .032, .004);
	State Florida = new State("Florida", 29, 15839713, .72, .441, .49, .056, .017, 0);
	State Georgia = new State("Georgia", 16, 7604061, .73, .475, .452, .072, .004, .008);
	
	State Hawaii = new State("Hawaii", 4, 1111117, .55, .274, .634, .072, .057, 0);
	State Idaho = new State("Idaho", 4, 1203384, .72, .527, .346, .108, .032, .177);
	State Illinois = new State("Illinois", 20, 9892106, .67, .373, .542, .07, .026, .004);
	State Indiana = new State("Indiana", 11, 5014928, .55, .479, .423, .099, .005, 0);
	State Iowa = new State("Iowa", 6, 2310467, .69, .417, .477, .094, .018, .02);
	...
	State Massachusetts = new State("Massachusetts", 11, 5354940, .72, .322, .573, .088, .03, .002);
	State Michigan = new State("Michigan", 16, 7686087, .6, .384, .498, .104, .031, .005);
	State Minnesota = new State("Minnesota", 10, 4175347, .71, .399, .494, .095, .031, .045);
	...
	State Nevada = new State("Nevada", 6, 2175874, .73, .428, .477, .081, 0, 0);
	State New_Hampshire = new State("New_Hampshire", 4, 1035684, .72, .419, .479, .09, .019, .003);
	State New_Jersey = new State("New_Jersey", 14, 6926094, .65, .398, .521, .068, .035, 0);
	
	State New_Mexico = new State("New_Mexico", 5, 1583623, .59, .37, .475, .142, .019, .011);
	State New_York = new State("New_York", 29, 15517321, .65, .354, .561, .069, .042, .004);
	State North_Carolina = new State("North_Carolina", 15, 7656415, .65, .46, .479, .061, .006, 0);
	State North_Dakota = new State("North_Dakota", 3, 570955, .58, .482, .396, .107, .019, 0);
	State Ohio = new State("Ohio", 18, 8955859, .68, .428, .464, .096, .025, .007);
	State Oklahoma = new State("Oklahoma", 7, 2925352, .46, .566, .352, .082, 0, 0);
	State Oregon = new State("Oregon", 7, 3112217, .67, .401, .493, .093, .049, 0);
	State Pennsylvania = new State("Pennsylvania", 20, 10086316, .57, .417, .482, .089, .03, .004);
	State Rhode_Island = new State("Rhode_Island", 4, 842321, .57, .341, .553, .09, .038, .003);
	State South_Carolina = new State("South_Carolina", 9, 3747734, .64, .474, .442, .069, .018, .029);

	State South_Dakota = new State("South_Dakota", 3, 642768, .66, .481, .403, .1, 0, 0);
	State Tennessee = new State("Tennessee", 11, 5054826, .58, .505, .411, .068, .015, .012);
	State Texas = new State("Texas", 38, 19841344, .56, .489, .431, .065, .016, .01);
	State Utah = new State("Utah", 6, 2038787, .79, .379, .299, .112, .027, .189);
	State Vermont = new State("Vermont", 3, 504976, .64, .306, .582, .094, .063, .006);
	State Virginia = new State("Virginia", 13, 6457174, .69, .426, .49, .073, .017, .033);
	State Washington = new State("Washington", 12, 5458809, .75, .383, .512, .091, .033, 0);
	State Washington_D_C = new State("Washington_D_C", 3, 543588, .62, .093, .825, .052, .045, 0);
	State West_Virginia = new State("West_Virginia", 5, 1470179, .54, .553, .348, .083, .029, .004);
	State Wisconsin = new State("Wisconsin", 10, 4457375, .64, .407, .503, .077, .022, .009);
